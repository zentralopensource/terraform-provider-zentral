...
page_title: "zentral_mdm_dep_enrollment_custom_view Resource - terraform-provider-zentral"
subcategory: ""
description: |-
  The resource zentral_mdm_dep_enrollment_custom_view manages MDM DEP enrollments custom views.
---

# zentral_mdm_dep_enrollment_custom_view (Resource)
...
- `custom_view_id` (String) ID of MDM custom view.
- `dep_enrollment_id` (Number) ID of MDM DEP enrollment.

### Optional

- `weight` (Number) Custom views are ordered by increasing weight. Defaults to `0`.

### Read-Only

- `id` (String) ID of the MDM DEP enrollment custom view.
