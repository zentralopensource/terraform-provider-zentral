...
func (p *ZentralProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewMDMCertAssetResource,
		NewMDMDataAssetResource,
		NewMDMDeclarationResource,
		NewMDMDEPEnrollmentResource,
		NewMDMDEPEnrollmentCutomViewResource,
		NewMDMEnrollmentCustomViewResource,
		...
		NewMDMSCEPIssuerResource,
		NewMDMSoftwareUpdateEnforcementResource,
		NewMDMStoreAppResource,
...
func (p *ZentralProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewMDMDEPEnrollmentDataSource,
		NewMDMDEPEnrollmentCustomViewDataSource,
		NewMDMDEPVirtualServerDataSource,
		NewMDMEnrollmentCustomViewDataSource,
		NewMDMLocationDataSource,
		NewMDMLocationAssetDataSource,
		NewMDMOTAEnrollmentDataSource,
		NewMDMPushCertificateDataSource,
		NewMDMRecoveryPasswordConfigDataSource,
		NewMDMSCEPIssuerDataSource,
